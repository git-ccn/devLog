    ...
    <div class="login-card-wrapper">
      <div class="login-card">
        ...
        <div class="login-right">
          ...
          <el-form :model="registerForm" :rules="rules" ref="registerFormRef" class="login-form" @keyup.enter="onRegister">
            ...
            <el-form-item>
              <el-button type="primary" :loading="loading" class="login-btn" @click="onRegister">注册</el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
